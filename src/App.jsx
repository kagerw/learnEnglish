...
const vocabularyData = [
  ...
  { english: "magnificent", japanese: "壮大な", difficulty: "intermediate", hint: "m から始まる、素晴らしく立派な", example: "The view from the mountain top was absolutely magnificent.", example_jp: "山頂からの眺めは本当に壮だった。" },
          ...
          <div className="mb-8 p-6 bg-gray-50 rounded-2xl">
            ...
            {uploadedFileName ? (
              ...
              <div className="mb-4">
                ...
                <label
                  htmlFor="csv-upload"
                  className="block w-full p-4 border-2 border-dashed rounded-lg cursor-pointer transition-all duration-200 border-indigo-300 hover:border-indigo-500 hover:bg-indigo-50"
                >
          ...
          <div className="mt-4">
            ...
            <div className="w-full bg-white/20 rounded-full h-2">
              <div 
                ...
                style={{ width: `${maxQuestions === 0 ? (currentVocabularyData.length > 0 ? (questionCount / currentVocabularyData.length) * 100 : 0) : Math.min(100, (questionCount / maxQuestions) * 100)}%` }}
              ></div>
            </div>
          </div>
        </div>
...
# VSCode Open Tabs
postcss.config.cjs
src/VocabularyGameApp.jsx
src/main.jsx
vite.config.js
src/App.jsx

# Actively Running Terminals
## Original command: `cd .. ; ren react_learnEnglish react_learnEnglish_old ; npm create vite@latest react_learnEnglish -- --template react ; cd react_learnEnglish ; npm install ; npm install -D tailwindcss postcss autoprefixer ; npx tailwindcss init -p ; npm install lucide-react`
## Original command: `npm run dev`
### New Output

20:49:11 [vite] hmr update /src/App.jsx, /src/index.css (x6)

# Current Time
6/24/2025, 8:49:15 PM (Asia/Tokyo, UTC+9:00)

# Context Window Usage
130,227 / 1,048.576K tokens used (12%)
